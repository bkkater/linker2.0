...
function November() {
    ...
    function handleNavigateToDecember() {
        navigate('December')
    }
    ...
    return (
        <View style={{ alignItems: "center" }}>
            ...
            <View style={style.month}>
                <BorderlessButton onPress={handleNavigateToOctober}><Feather name="chevron-left" size={24} color="#929090" /></BorderlessButton>
                <Text style={style.monthText}>Novembro</Text>
                <BorderlessButton onPress={handleNavigateToDecember}><Feather name="chevron-right" size={24} color="#929090" /></BorderlessButton>
            </View>
