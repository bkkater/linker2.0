    ...
    return (
        <View style={{ alignItems: "center" }}>
            ...
            <View style={style.month}>
                <BorderlessButton onPress={handleNavigateToNovember}><Feather name="chevron-left" size={24} color="#929090" /></BorderlessButton>
                <Text style={style.monthText}>Dezembro</Text>
                <BorderlessButton><Feather name="chevron-right" size={24} color="transparent" /></BorderlessButton>
            </View>
